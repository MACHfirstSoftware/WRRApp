...
class _$ApiResultTearOff {
  ...
  Error<T> responseError<T>({required ResponseError responseError}) {
    return Error<T>(
...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ResponseError responseError) responseError,
  }) =>
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(ResponseError responseError)? responseError,
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(Error<T> value) responseError,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>({
    ...
    TResult Function(Error<T> value)? responseError,
    required TResult orElse(),
  }) =>
      throw _privateConstructorUsedError;
}
...
class _$Error<T> with DiagnosticableTreeMixin implements Error<T> {
  const _$Error({required this.responseError});
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ApiResult<$T>.responseError(responseError: $responseError)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ApiResult<$T>.responseError'))
  ...
  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(responseError);
  ...
  TResult when<TResult extends Object?>({
    ...
    return responseError(this.responseError);
  }
...
abstract class Error<T> implements ApiResult<T> {
  const factory Error({required ResponseError responseError}) = _$Error<T>;

  ResponseError get responseError => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $ErrorCopyWith<T, Error<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
